...
kbdcfg.add_primary_layout("Slovak (qwerty)", "SK", "sk(qwerty)")
kbdcfg.bind()
...
beautiful.init("/home/revolko/.config/awesome/theme.lua")
...
globalkeys = gears.table.join(
    ...
    awful.key({"Mod4"}, "space", function () kbdcfg.switch_next() end)
)
